...
dashboardControllers.controller('websites',
    ...
    function ($scope, Website) {
        ...
        $scope.deleteSite = function() {
            Website.delete({websiteId: $scope.deleted.id}, function() {
                $scope.sites.splice($scope.sites.indexOf($scope.deleted));
            });
...
dashboardControllers.controller('pages',
    ...
    function($scope, Website, Page) {
        ...
        $scope.updatePage = function() {
            Page.update({websiteId: selectedSiteId, pageId: updatedPage.id},
        ...
        $scope.deletePage = function() {
            Page.delete({websiteId: selectedSiteId, pageId: $scope.deleted.id},
                function() {
                    $scope.pages.splice($scope.pages.indexOf($scope.deleted));
