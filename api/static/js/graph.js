...
var Node=Class.extend({
 ...
 this.y=0;
 this._x=a.x;this._y=a.y;this._vx=0;this._vy=0;this.radius=a.radius;this.fixed=a.fixed;this.fill=a.fill;this.stroke=a.stroke;this.strokewidth=a.strokewidth;this.weight=a.weight || 0;this.centrality=a.centrality || 0;this.text=null;if(a.text !=false){
...
var Graph=Class.extend({
 ...
 loop: function(a){
 if(a===undefined)a={};if(a.frames===undefined)a.frames=500;if(a.fps===undefined)a.fps=20;if(a.ipf===undefined)a.ipf=2;this._i=0;this._frames=a.frames;this._animation=setInterval(function(g){
 if(g._i < g._frames){
