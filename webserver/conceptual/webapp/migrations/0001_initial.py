...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'webapp_website', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='websites', to=orm['auth.User'])),
            ...
            ('embed_src', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal(u'webapp', ['Website'])

        # Adding model 'Page'
        db.create_table(u'webapp_page', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('website', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pages', to=orm['webapp.Website'])),
        ))
        db.send_create_signal(u'webapp', ['Page'])


    def backwards(self, orm):
        # Deleting model 'Website'
        db.delete_table(u'webapp_website')

        # Deleting model 'Page'
        db.delete_table(u'webapp_page')
