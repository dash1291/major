...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Website', fields ['url']
        db.create_index(u'webapp_website', ['url'])

        # Adding index on 'Page', fields ['url']
        db.create_index(u'webapp_page', ['url'])


    def backwards(self, orm):
        # Removing index on 'Page', fields ['url']
        db.delete_index(u'webapp_page', ['url'])

        # Removing index on 'Website', fields ['url']
        db.delete_index(u'webapp_website', ['url'])
