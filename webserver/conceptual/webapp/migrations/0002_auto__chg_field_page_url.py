...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'webapp_page', 'url', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Page.url'
        db.alter_column(u'webapp_page', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
